...
import { IUser } from '../models/user.models'; // For student's name
import { RESULT_STATUSES } from './seedConstants';
import { getRandomElement } from './seedUtils';
import { Result } from '../models/result.models';
import { IGrade } from '../models/grades.models';
...
function generateRandomResultData(
  studentDoc: IStudent, // Student Profile
  classDoc: IClass,
  courseDoc: ICourse,
  studentGradesForCourse: IGrade[],
  studentUser: IUser // The User document for the student for their name
): ResultData {
...
export async function seedResults(
  ...
  allCourses: ICourse[],
  allGrades: IGrade[],
  allUsers: IUser[] // To get student's full name
): Promise<any[]> {
...
export function setExamAndAssignmentStore(exams: any[], assignments: any[]) {
  allExams = exams;
